<h2><a href="https://leetcode.com/problems/sum-of-special-evenly-spaced-elements-in-array/">1714. Sum Of Special Evenly-Spaced Elements In Array</a></h2><h3>Hard</h3><hr><div><p>You are given a <strong>0-indexed</strong> integer array <code>nums</code> consisting of <code>n</code> non-negative integers.</p>
...
<pre><strong>Input:</strong> nums = [0,1,2,3,4,5,6,7], queries = [[0,3],[5,1],[4,2]]
...
<pre><strong>Input:</strong> nums = [100,200,101,201,102,202,103,203], queries = [[0,7]]
