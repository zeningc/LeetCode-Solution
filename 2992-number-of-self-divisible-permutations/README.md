<h2><a href="https://leetcode.com/problems/number-of-self-divisible-permutations/">2992. Number of Self-Divisible Permutations</a></h2><h3>Medium</h3><hr><div><p>Given an integer <code>n</code>, return <em>the number of <strong>permutations</strong> of the <strong>1-indexed</strong> array</em> <code>nums = [1, 2, ..., n]</code><em>, such that it's <strong>self-divisible</strong></em>.</p>
