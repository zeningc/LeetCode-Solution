<h2><a href="https://leetcode.com/problems/minimum-time-to-kill-all-monsters/">2403. Minimum Time to Kill All Monsters</a></h2><h3>Hard</h3><hr><div><p>You are given an integer array <code>power</code> where <code>power[i]</code> is the power of the <code>i<sup>th</sup></code> monster.</p>
...
<pre><strong>Input:</strong> power = [3,1,4]
...
<pre><strong>Input:</strong> power = [1,1,4]
<strong>Output:</strong> 4
<strong>Explanation:</strong> The optimal way to beat all the monsters is to:
...
<pre><strong>Input:</strong> power = [1,2,4,9]
