<h2><a href="https://leetcode.com/problems/minimize-max-distance-to-gas-station/">774. Minimize Max Distance to Gas Station</a></h2><h3>Hard</h3><hr><div><p>You are given an integer array <code>stations</code> that represents the positions of the gas stations on the <strong>x-axis</strong>. You are also given an integer <code>k</code>.</p>
